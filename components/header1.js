        ...
        <header data-thq="thq-navbar" className="header1-navbar-interactive">
          ...
          >
            ...
            >
              ...
              <Link href="/services">
                <a className="header1-link03">Services</a>
              </Link>
              <Link href="/about-us">
                <a className="header1-link04">About Us</a>
              </Link>
            </nav>
          </div>
          <div data-thq="thq-navbar-btn-group" className="header1-btn-group">
            <Link href="/contactus">
              <a className="header1-link05 button">CONTACT US </a>
            </Link>
          </div>
          ...
          <div data-thq="thq-mobile-menu" className="header1-mobile-menu">
            ...
            >
              ...
              >
                <Link href="/work">
                  <a className="header1-link06">Work</a>
                </Link>
                <Link href="/services">
                  <a className="header1-link07">Services</a>
                </Link>
                <Link href="/career">
                  <a className="header1-link08">Careers</a>
                </Link>
                <Link href="/blog">
                  <a className="header1-link09">Blogs</a>
                </Link>
                <Link href="/about-us">
                  <a className="header1-link10">About Us</a>
                </Link>
                <Link href="/contactus">
                  <a className="header1-link11">Contact Us</a>
                </Link>
              </nav>
