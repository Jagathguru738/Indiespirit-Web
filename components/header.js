  ...
  return (
    <>
      <div className={`header-container ${props.rootClassName} `}>
        <header data-thq="thq-navbar" className="header-navbar-interactive" data-aos="fade-down" data-aos-duration="1000">
          <Link href="/">
          ...
          >
            ...
            >
              ...
              <Link href="/about-us">
                <a className="header-link04">About Us</a>
              </Link>
            </nav>
          </div>
          <div data-thq="thq-navbar-btn-group" className="header-btn-group">
            <Link href="/contactus">
              <a className="header-link05 button">CONTACT US </a>
            </Link>
          </div>
          ...
          <div data-thq="thq-mobile-menu" className="header-mobile-menu">
            ...
            >
              ...
              >
                <Link href="/work">
                  <a className="header-link06">Work</a>
                </Link>
                <Link href="/services">
                  <a className="header-link07">Services</a>
                </Link>
                <Link href="/career">
                  <a className="header-link08">Careers</a>
                </Link>
                <Link href="/blog">
                  <a className="header-link09">Blogs</a>
                </Link>
                <Link href="/about-us">
                  <a className="header-link10">About Us</a>
                </Link>
                <Link href="/contactus">
                  <a className="header-link11">Contact Us</a>
                </Link>
              </nav>
