      ...
      <section className="work-container">
        ...
        <main className="work-container1">
          <h1 className="work-text">
            <span className="work-text01">Experienced companies,</span>
            <span>
              <span
            ...
            <span className="work-text07">startups</span>
          </h1>
        </main>
        ...
        <section className="work-container2">
          ...
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image01"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image02"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image03"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image04"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image05"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image06"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image07"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image08"
          />
          <img
            alt="image"
            src="/playground_assets/rectangle%206l-600w.png"
            className="work-image09"
          />
