  ...
  return (
    <>
      <div className="home-container">
        ...
        <section className="home-container1" data-aos="fade-in" >
          <span className="home-text" data-aos="fade-down" data-aos-duration="500">
            <span className="home-text001">Creative</span>
            <span>
              <span
            ...
            <span className="home-text003">studio for </span>
            <br className="home-text004"></br>
            <span className="home-text005">world-class brands</span>
            <span className="home-text006">*</span>
            <br></br>
            <br></br>
          </span>
          <span className="home-text009" data-aos="fade-down" data-aos-duration="500">
            <span className="home-text010">*</span>
          ...
          <video
            ...
            autoPlay
            controls
            className="home-video1" data-aos="zoom-in" data-aos-duration="1000"  
          ></video>
          <div className="home-div" data-aos="fade-down" data-aos-duration="1000">
            <DangerousHTML
              html={`<!DOCTYPE html>
<html lang="en">
  <head>
...
`}
        ...
        <section className="home-container2" data-aos="fade-up" data-aos-duration="1000">
          ...
          <span className="home-text036" data-aos="zoom-in-up" data-aos-duration="1000">ABOUT</span>
          <span className="home-text037" data-aos="zoom-in-up" data-aos-duration="1000">Brand / UI &amp; UX / Front-end</span>
          <span className="home-text038" data-aos="zoom-in-up" data-aos-duration="1000">Brand / UI &amp; UX / Front-end</span>
          <span className="home-text039" data-aos="zoom-in-up" data-aos-duration="1000">Brand / UI &amp; UX / Front-end</span>
          <span className="home-text040" data-aos="zoom-in-up" data-aos-duration="1000">Brand / UI &amp; UX / Front-end</span>
          <span className="home-text041" data-aos="zoom-in-up" data-aos-duration="1000">Brand / UI &amp; UX / Front-end</span>
          <span className="home-text042" data-aos="zoom-in-up" data-aos-duration="1000">Brand / UI &amp; UX / Front-end</span>
          <span className="home-text043" data-aos="zoom-in-up" data-aos-duration="1000">Convo</span>
          <span className="home-text044" data-aos="zoom-in-up" data-aos-duration="1000">Convo</span>
          <span className="home-text045" data-aos="zoom-in-up" data-aos-duration="1000">Convo</span>
          <span className="home-text046" data-aos="zoom-in-up" data-aos-duration="1000">Convo</span>
          <span className="home-text047" data-aos="zoom-in-up" data-aos-duration="1000">Convo</span>
          <span className="home-text048" data-aos="zoom-in-up" data-aos-duration="1000">Convo</span>
          <span className="home-text049" data-aos="zoom-in-up" data-aos-duration="1000">OUR WORK</span>
          <img
            alt="image"
        ...
        <section className="home-container3" data-aos="fade-up" data-aos-duration="1000">
          ...
          <span className="home-text054" data-aos="fade-right" data-aos-duration="1000">
            <span>
            ...
            <br className="break" data-aos="fade-left" data-aos-duration="1000"></br>
            <span>
              {' '}
              not
              <span
          ...
          <ul className="list home-ul" data-aos="fade-left" data-aos-duration="1000">
            <li className="list-item"></li>
          </ul>
          <li className="home-li01 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li02 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li03 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li04 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li05 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li06 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li07 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li08 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li09 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li10 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li11 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li12 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li13 list-item"  data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li13 list-item"  data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li14 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li15 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li16 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
          <li className="home-li17 list-item" data-aos="fade-left" data-aos-duration="1000"></li>
        </section>
        <div className="home-container4" data-aos="fade-up" data-aos-duration="1000">
          <span className="home-text078" data-aos="fade-right" data-aos-duration="1000">TESTIMONIALS</span>
          ...
          <span className="home-text081" data-aos="fade-in" data-aos-duration="1000">
            <span>
        ...
        <section className="home-container5" data-aos="fade-up" data-aos-duration="1000">
          ...
          <span className="home-text108">E-MAIL</span>
          <span className="home-text109">PHONE NUMBER</span>
          <span className="home-text110">hello@outloud.com</span>
          <span className="home-text111">+421 948 243 101</span>
          <Link href="/contactus">
