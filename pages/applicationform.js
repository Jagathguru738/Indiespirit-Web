    ...
    <>
      <div className="applicationform-container">
        ...
        <div className="applicationform-container1">
          ...
          <span className="applicationform-text03">Full Name</span>
          <span className="applicationform-text04">
            <span>Email Address</span>
            <br></br>
          </span>
          <span className="applicationform-text07">Resume / CV</span>
          ...
          <div className="applicationform-separator"></div>
          <div className="applicationform-separator1"></div>
          <div className="applicationform-separator2"></div>
