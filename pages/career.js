      ...
      <div className="career-container">
        ...
        <div className="career-container1">
          <h1 className="career-text">
            ...
            <span className="career-text03">join the team</span>
          </h1>
          <Link href="/current-opening">
            <a className="career-link button">Current Opening</a>
          </Link>
        ...
        <div className="career-container2">
          <span className="career-text04">What we offer</span>
          <span className="career-text05">Team over hierarchy</span>
          <span className="career-text06">Flexibility at work</span>
          <span className="career-text07">Personal growth</span>
          <span className="career-text08">
            We propose the best solutions in every way – strategical,
            contentual, visual.
          </span>
          <span className="career-text09">
            First, we get to know your status, needs and expectations.
          </span>
          <span className="career-text10">
            <span>
          ...
          <span className="career-text15">Competitive salary</span>
          <span className="career-text16">
            ...
            <span>in sprints and favour evolution over revolution.</span>
          </span>
          <div className="career-separator"></div>
          <div className="career-separator1"></div>
          <div className="career-separator2"></div>
          <div className="career-separator3"></div>
          <span className="career-text19">01</span>
          <span className="career-text20">04</span>
          <span className="career-text21">03</span>
          <span className="career-text22">02</span>
        </div>
